...
然后配置各种参数启动虚拟机：
	...
	--ram 4096 \
	--vcpus=2 \
	--check-cpu --os-type=linux -c /home/luxurioust/CentOS-6.4-x86_64-LiveCD.iso --disk path=/opt/centos.img,device=disk,bus=ide,format=qcow2 --bridge=br0 --vnc --vncport=5901 --vnclisten=0.0.0.0